...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 md:py-40 relative overflow-hidden text-white/90" ref={containerRef}>
        ...
        >
          ...
          <div className="flex flex-col gap-8 xl:pr-8">
            ...
            <div className="flex flex-col gap-6">
              <p className="text-lg md:text-xl text-white/90/80 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-8 pt-8 border-t border-gray-300">
              {stats.map((stat, i) => (
                <div key={i} className="border-l-2 border-primary/50 pl-4">
                  <div 
                    className="text-4xl md:text-5xl font-bold text-white jt-pill mb-2"
                    ref={(el) => {
